% C_train_small_strain_on_test_large_strain.m
clear; clc; close all;
...
% Set y-axis to log scale to visualize the divergence at high strain
set(gca, 'YScale', 'log');
...
% Y-axis label (noting the log scale)
ylabel('First P-K stress ($P_{11}$, or $P_{22}$) [log scale]', ...
       'FontSize', 18, 'Interpreter', 'latex', 'FontName', 'Times New Roman');
...
% print('C_train_small_strain_plot', '-dpng', '-r300');