% Calender_exp_power.m
% This script loads and plots experimental and predicted stress-stretch data
% for calendered material under uniaxial and biaxial loading.

clear; clc; close all;

% --- Data Loading and Processing ---

% 1. Load Uniaxial Data (P11) from the calendered power_exp file
uniaxial_filename = 'uniaxial_predictions_calendered_power_exp.csv';
...
% 2. Load Biaxial Data (P22) from the calendered power_exp file
biaxial_filename = 'biaxial_predictions_Calendered_power_exp.csv';
...
% Uniaxial (P11) - Dark magenta dashed line (matching calendered data plot)
...
pos(1) = pos(1) - 0.005; % Adjusted for better visual spacing
...
% print('calendered_power_exp_plot', '-dpng', '-r300'); % Saves a high-quality PNG