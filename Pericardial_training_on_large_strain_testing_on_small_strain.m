% Pericardial_training_on_large strain_testing_on_small_strain.m
clear; clc; close all;

% --- Data Loading and Processing ---
% Load the new CSV file.
filename = 'Pericardial, training on large strain, testing on small strain.csv';
...
% Optional: Save the figure with a new name
% print('pericardial_large_strain_training_plot', '-dpng', '-r300'); % Saves a high-quality PNG