% plot_pericardial_power_exp.m
clear; clc; close all;

% --- Data Loading and Processing ---

% 1. Load Uniaxial Data (P11) from the "power_exp" file
uniaxial_filename = 'task1_uniaxial_predictions_pericardial_power_exp.csv';
...
% 2. Load Biaxial Data (P22) from the "sinh_cosh_power" file
biaxial_filename = 'task2_biaxial_predictions_pericardial_sinh_cosh_power.csv';
...
% print('pericardial_power_exp_plot', '-dpng', '-r300'); % Saves a high-quality PNG